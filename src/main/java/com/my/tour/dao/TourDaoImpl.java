...
public class TourDaoImpl implements TourDao {
	...
	public int insertTour(String tourName, String tourContent, LocalDate tourSDate, LocalDate tourEDate,
			int tourPrice, int discountPrice, String adminId, int termNum) {
		return tourMap.insertTour(tourName, tourContent, tourSDate, tourEDate, tourPrice, discountPrice, adminId, termNum);
	}
